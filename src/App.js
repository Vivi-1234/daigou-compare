...
class SupabaseClient {
  ...
  async deleteFieldConfig(section_key, field_key) {
    return this.request(`/field_configs?section_key=eq.${section_key}&field_key=eq.${field_key}`, { method: 'DELETE' });
  }
